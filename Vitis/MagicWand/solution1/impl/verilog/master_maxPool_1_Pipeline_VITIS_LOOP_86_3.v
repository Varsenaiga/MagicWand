...
module master_maxPool_1_Pipeline_VITIS_LOOP_86_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln86_fu_164_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln86_reg_559 == 1'd0) & (1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln86_fu_164_p2 == 1'd0))) begin
        ifzero_reg_568 <= ifzero_fu_205_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln86_reg_559 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((icmp_ln86_reg_559 == 1'd1) & (1'b0 == ap_block_pp0_stage1_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
assign add_ln86_fu_170_p2 = (ap_sig_allocacmp_j_1 + 2'd1);

assign add_ln87_fu_194_p2 = (tmp2_fu_186_p3 + zext_ln80_cast_fu_142_p1);
...
assign icmp_ln86_fu_164_p2 = ((ap_sig_allocacmp_j_1 == 2'd3) ? 1'b1 : 1'b0);

assign ifzero_fu_205_p2 = ((add_ln86_fu_170_p2 == 2'd3) ? 1'b1 : 1'b0);

assign j_cast_fu_176_p1 = ap_sig_allocacmp_j_1;

assign m_address0 = zext_ln87_fu_200_p1;
...
assign zext_ln80_cast_fu_142_p1 = zext_ln80;

assign zext_ln87_fu_200_p1 = add_ln87_fu_194_p2;

endmodule //master_maxPool_1_Pipeline_VITIS_LOOP_86_3
