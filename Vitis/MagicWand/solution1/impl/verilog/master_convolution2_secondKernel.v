...
// ==============================================================
`timescale 1 ns / 1 ps
module master_convolution2_secondKernel (
...
initial begin
    $readmemh("./master_convolution2_secondKernel.dat", ram0);
    $readmemh("./master_convolution2_secondKernel.dat", ram1);
    $readmemh("./master_convolution2_secondKernel.dat", ram2);
    $readmemh("./master_convolution2_secondKernel.dat", ram3);
    $readmemh("./master_convolution2_secondKernel.dat", ram4);
    $readmemh("./master_convolution2_secondKernel.dat", ram5);
    $readmemh("./master_convolution2_secondKernel.dat", ram6);
    $readmemh("./master_convolution2_secondKernel.dat", ram7);
end
