...
// ==============================================================
`timescale 1 ns / 1 ps
module master_master_Pipeline_VITIS_LOOP_111_1_secondDense (
...
initial begin
    $readmemh("./master_master_Pipeline_VITIS_LOOP_111_1_secondDense.dat", ram0);
    $readmemh("./master_master_Pipeline_VITIS_LOOP_111_1_secondDense.dat", ram1);
    $readmemh("./master_master_Pipeline_VITIS_LOOP_111_1_secondDense.dat", ram2);
    $readmemh("./master_master_Pipeline_VITIS_LOOP_111_1_secondDense.dat", ram3);
    $readmemh("./master_master_Pipeline_VITIS_LOOP_111_1_secondDense.dat", ram4);
    $readmemh("./master_master_Pipeline_VITIS_LOOP_111_1_secondDense.dat", ram5);
    $readmemh("./master_master_Pipeline_VITIS_LOOP_111_1_secondDense.dat", ram6);
    $readmemh("./master_master_Pipeline_VITIS_LOOP_111_1_secondDense.dat", ram7);
end
