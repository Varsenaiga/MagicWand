...
entity master_maxPool_1_Pipeline_VITIS_LOOP_84_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    zext_ln78 : IN STD_LOGIC_VECTOR (2 downto 0);
...
architecture behav of master_maxPool_1_Pipeline_VITIS_LOOP_84_3 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln84_reg_559 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln85_fu_200_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal add_ln84_fu_170_p2 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal zext_ln78_cast_fu_142_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal add_ln85_fu_194_p2 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln84_fu_164_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln84_reg_559 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln84_fu_164_p2 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln84_reg_559 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
    ...
    add_ln84_fu_170_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_1) + unsigned(ap_const_lv2_1));
    add_ln85_fu_194_p2 <= std_logic_vector(unsigned(tmp2_fu_186_p3) + unsigned(zext_ln78_cast_fu_142_p1));
    ...
    ap_condition_exit_pp0_iter0_stage1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_subdone, icmp_ln84_reg_559)
    begin
        if (((icmp_ln84_reg_559 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    icmp_ln84_fu_164_p2 <= "1" when (ap_sig_allocacmp_j_1 = ap_const_lv2_3) else "0";
    ifzero_fu_205_p2 <= "1" when (add_ln84_fu_170_p2 = ap_const_lv2_3) else "0";
    j_cast_fu_176_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j_1),9));
    m_address0 <= zext_ln85_fu_200_p1(12 - 1 downto 0);
    ...
    zext_ln78_cast_fu_142_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln78),12));
    zext_ln85_fu_200_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln85_fu_194_p2),64));
end behav;
