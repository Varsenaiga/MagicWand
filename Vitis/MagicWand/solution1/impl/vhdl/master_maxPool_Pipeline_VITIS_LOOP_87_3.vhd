...
entity master_maxPool_Pipeline_VITIS_LOOP_87_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of master_maxPool_Pipeline_VITIS_LOOP_87_3 is 
...
begin
    fptrunc_64ns_32_2_no_dsp_1_U70 : component master_fptrunc_64ns_32_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    fpext_32ns_64_2_no_dsp_1_U71 : component master_fpext_32ns_64_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
