...
void master(float (*llvm_cbe_input)[3], float (*llvm_cbe_out)[4]);
...
void master_hw_stub(float (*llvm_cbe_input)[3], float (*llvm_cbe_out)[4]);
void apatb_master_sw(float (*llvm_cbe_input)[3], float (*llvm_cbe_out)[4]);
void apatb_master_ir(float (*)[3], float (*)[4]);
...
printf("\n\{ BEGIN @master\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = getelementptr inbounds [3 x float]* %%input, i64 0, i64 0, !dbg !9 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_11_count);
  llvm_cbe_tmp__1 = (float *)(&(*llvm_cbe_input)[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 3
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = bitcast [128 x [3 x [8 x float]]]* %%conv1 to float*, !dbg !9 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_12_count);
  llvm_cbe_tmp__2 = (float *)((float *)(&llvm_cbe_conv1));
if (AESL_DEBUG_TRACE)
printf("\n  call void @convolution1(i32 128, i32 3, float* %%1, i32 4, i32 3, i32 8, float* getelementptr inbounds ([8 x [4 x [3 x float]]]* @firstKernel, i64 0, i64 0, i64 0, i64 0), float* getelementptr inbounds ([8 x float]* @firstBias, i64 0, i64 0), float* %%2) nounwind, !dbg !9 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_13_count);
  convolution1(128u, 3u, (float *)llvm_cbe_tmp__1, 4u, 3u, 8u, (float *)((&firstKernel[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 8
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = bitcast [42 x [1 x [8 x float]]]* %%max1 to float*, !dbg !9 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_14_count);
  llvm_cbe_tmp__3 = (float *)((float *)(&llvm_cbe_max1));
if (AESL_DEBUG_TRACE)
printf("\n  call void @maxPool(i32 128, i32 3, i32 8, float* %%2, i32 42, i32 1, float* %%3, i32 3, i32 3) nounwind, !dbg !9 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_15_count);
  maxPool(128u, 3u, 8u, (float *)llvm_cbe_tmp__2, 42u, 1u, (float *)llvm_cbe_tmp__3, 3u, 3u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",128u);
printf("\nArgument  = 0x%X",3u);
printf("\nArgument  = 0x%X",8u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = bitcast [42 x [1 x [16 x float]]]* %%conv2 to float*, !dbg !9 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_16_count);
  llvm_cbe_tmp__4 = (float *)((float *)(&llvm_cbe_conv2));
if (AESL_DEBUG_TRACE)
printf("\n  call void @convolution2(i32 42, i32 1, i32 8, float* %%3, i32 4, i32 8, i32 16, float* getelementptr inbounds ([16 x [4 x [8 x float]]]* @secondKernel, i64 0, i64 0, i64 0, i64 0), float* getelementptr inbounds ([16 x float]* @secondBias, i64 0, i64 0), float* %%4) nounwind, !dbg !9 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_17_count);
  convolution2(42u, 1u, 8u, (float *)llvm_cbe_tmp__3, 4u, 8u, 16u, (float *)((&secondKernel[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 16
#endif
][(((signed long long )0ull))
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = bitcast [14 x [1 x [16 x float]]]* %%max2 to float*, !dbg !9 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_18_count);
  llvm_cbe_tmp__5 = (float *)((float *)(&llvm_cbe_max2));
if (AESL_DEBUG_TRACE)
printf("\n  call void @maxPool(i32 42, i32 1, i32 16, float* %%4, i32 14, i32 1, float* %%5, i32 3, i32 1) nounwind, !dbg !9 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_19_count);
  maxPool(42u, 1u, 16u, (float *)llvm_cbe_tmp__4, 14u, 1u, (float *)llvm_cbe_tmp__5, 3u, 1u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",42u);
printf("\nArgument  = 0x%X",1u);
printf("\nArgument  = 0x%X",16u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = getelementptr inbounds [1 x [16 x float]]* %%den1, i64 0, i64 0, i64 0, !dbg !9 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_20_count);
  llvm_cbe_tmp__6 = (float *)(&llvm_cbe_den1[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 1
#endif
][(((signed long long )0ull))
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @dense1(i32 14, i32 1, i32 16, float* %%5, i32 14, i32 16, i32 16, float* getelementptr inbounds ([16 x [14 x [16 x float]]]* @firstDense, i64 0, i64 0, i64 0, i64 0), float* getelementptr inbounds ([16 x float]* @thirdBias, i64 0, i64 0), i32 16, float* %%6) nounwind, !dbg !9 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_21_count);
  dense1(14u, 1u, 16u, (float *)llvm_cbe_tmp__5, 14u, 16u, 16u, (float *)((&firstDense[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 16
#endif
][(((signed long long )0ull))
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds [1 x [4 x float]]* %%den2, i64 0, i64 0, i64 0, !dbg !9 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_22_count);
  llvm_cbe_tmp__7 = (float *)(&llvm_cbe_den2[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 1
#endif
][(((signed long long )0ull))
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @dense2(i32 16, float* %%6, i32 16, i32 4, float* getelementptr inbounds ([4 x [16 x float]]* @secondDense, i64 0, i64 0, i64 0), float* getelementptr inbounds ([4 x float]* @fourthBias, i64 0, i64 0), i32 4, float* %%7) nounwind, !dbg !9 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_23_count);
  dense2(16u, (float *)llvm_cbe_tmp__6, 16u, 4u, (float *)((&secondDense[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
][(((signed long long )0ull))
...
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = getelementptr inbounds [4 x float]* %%out, i64 0, i64 0, !dbg !6 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_24_count);
  llvm_cbe_tmp__8 = (float *)(&(*llvm_cbe_out)[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @softmax(i32 4, float* %%7, float* %%8) nounwind, !dbg !6 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_25_count);
  softmax(4u, (float *)llvm_cbe_tmp__7, (float *)llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",4u);
}
  if (AESL_DEBUG_TRACE)
...
const char* AESL_DEBUG_TRACE = getenv("DEBUG_TRACE");
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @master_hw_stub\n");
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @master([3 x float]* %%input, [4 x float]* %%out), !dbg !6 for 0x%I64xth hint within @master_hw_stub  --> \n", ++aesl_llvm_cbe_31_count);
   /*tail*/ master(llvm_cbe_input, llvm_cbe_out);
if (AESL_DEBUG_TRACE) {
}
  if (AESL_DEBUG_TRACE)
      printf("\nEND @master_hw_stub}\n");
...
const char* AESL_DEBUG_TRACE = getenv("DEBUG_TRACE");
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @apatb_master_sw\n");
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @apatb_master_ir([3 x float]* %%input, [4 x float]* %%out) nounwind, !dbg !6 for 0x%I64xth hint within @apatb_master_sw  --> \n", ++aesl_llvm_cbe_37_count);
   /*tail*/ apatb_master_ir(llvm_cbe_input, llvm_cbe_out);
if (AESL_DEBUG_TRACE) {
}
  if (AESL_DEBUG_TRACE)
      printf("\nEND @apatb_master_sw}\n");
