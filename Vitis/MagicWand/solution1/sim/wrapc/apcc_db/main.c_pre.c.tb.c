...
signed int compareFiles( char *,  char *);


/* Global Variable Definitions and Initialization */
static  char aesl_internal__OC_str[40] = "../../../data/negative/output_teste.txt";
static  char aesl_internal__OC_str1[2] = "r";
static  char aesl_internal__OC_str3[13] = "original.txt";
static  char aesl_internal__OC_str4[9] = "test.txt";
...
if (AESL_DEBUG_TRACE)
printf("\n  %%puts = tail call i32 @puts(i8* getelementptr inbounds ([19 x i8]* @aesl_internal_str, i64 0, i64 0)), !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_puts_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = tail call i32 @compareFiles(i8* getelementptr inbounds ([13 x i8]* @aesl_internal_.str3, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @aesl_internal_.str4, i64 0, i64 0)) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_7_count);
  llvm_cbe_tmp__2 = (unsigned int ) /*tail*/ compareFiles(( char *)((&aesl_internal__OC_str3[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 13
#endif
