...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "master.autotvin.dat"
	set constFileTvOut       "master.autotvout.dat"
	set constFileHdlTvIn     "master.autohdltvin.dat"
	set constFileHdlTvOut    "master.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
