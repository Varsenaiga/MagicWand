...
$(ObjDir)/file.c_pre.c.tb.o : file.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) file.c_pre.c.tb.c" $(AVE_DIR_DLOG)
...
$(ObjDir)/utils.c_pre.c.tb.o : utils.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) utils.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/model_functions.c_pre.c.tb.o : model_functions.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) model_functions.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/master.c_pre.c.tb.o : master.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) master.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
