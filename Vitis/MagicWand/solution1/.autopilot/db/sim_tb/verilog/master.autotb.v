...
`define AUTOTB_DUT      master
`define AUTOTB_DUT_INST AESL_inst_master
`define AUTOTB_TOP      apatb_master_top
`define AUTOTB_LAT_RESULT_FILE "master.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "master.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_master_top
...
`define AUTOTB_TVIN_input_r  "./c.master.autotvin_input_r.dat"
`define AUTOTB_TVIN_out_r  "./c.master.autotvin_out_r.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "./rtl.master.autotvin_input_r.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.master.autotvin_out_r.dat"
`define AUTOTB_TVOUT_out_r  "./c.master.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.master.autotvout_out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 4;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 442811;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    fp1 = $fopen("./rtl.master.autotvout_out_r.dat", "r");
    fp2 = $fopen("./impl_rtl.master.autotvout_out_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.master.autotvout_out_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.master.autotvout_out_r.dat\"!");
    else begin
        $display("Comparing rtl.master.autotvout_out_r.dat with impl_rtl.master.autotvout_out_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
