...
set C_modelName {convolution1.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_r int 32 regular {array 384 { 1 1 } 1 1 }  }
	{ out_r float 32 regular {array 3072 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.firstKernel_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.firstBias_U", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "60441", "Max" : "223257"}
	, {"Name" : "Interval", "Min" : "60441", "Max" : "223257"}
]}
