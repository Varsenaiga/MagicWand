...
printf("\n\{ BEGIN @master\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call %%struct._iobuf* @openFile(i8* getelementptr inbounds ([40 x i8]* @aesl_internal_.str, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @aesl_internal_.str1, i64 0, i64 0)) nounwind, !dbg !1 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_1_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @readFile(%%struct._iobuf* %%1) nounwind, !dbg !3 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_5_count);
   /*tail*/ readFile((l_struct_OC__iobuf *)llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @closeFile(%%struct._iobuf* %%1) nounwind, !dbg !3 for 0x%I64xth hint within @master  --> \n", ++aesl_llvm_cbe_6_count);
